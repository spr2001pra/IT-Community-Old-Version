...
public class RedisKeyUtil {
    ...
    private static final String POST_UV = "uvRecord";
    private static final String POST_DAU = "dauRecord";
    ...
    // 统计UV
    public static String getUVKeyRecord(String date){
        return POST_UV + SPLIT + date;
    }
